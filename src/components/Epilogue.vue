<template>
  <div id="epilogue">
    ...
    <p>Según estimaciones de directivos del INPEC, reparar la cárcel costará 5 mil millones de pesos.</p>
    <p>
      La Procuraduria abrió una investigación preliminar por posible exceso de fuerza en la reacción para contener el
      motín.
    </p>
    <p>Esa noche hubo motines en otros 13 penales del país.</p>
  </div>
</template>
